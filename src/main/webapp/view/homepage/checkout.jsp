		...
		<section class="checkout-grid">
			...
			<form class="panel" style="background: rgba(255, 255, 255, 0.97);">
				...
				<div style="display:flex; gap: 20px">
					<div style="display: grid; gap: 8px; width:50%">
			...
			<section class="summary">
				...
				<table style="margin-top:14px; border-collapse: collapse;">
					...
					<tbody>
						...
						<tr>
							...
							<td><fmt:formatNumber value="${cart.totalPrice}" type="number" /></td>
						</tr>
						</c:forEach>
						<tr>
							<td><h5>Tạm tính:</h5></td>
							<td><h5><fmt:formatNumber value="${totalPrice}" type="number" /></h5></td>
						</tr>
						<tr>
							<td><h5>Giảm giá:</h5></td>
							<td><h5><fmt:formatNumber value="${discount}" type="number" /></h5></td>
						</tr>
						<tr>
							<td><Strong>Tổng:</Strong></td>
							<td><strong><fmt:formatNumber value="${finalPrice}" type="number" /></strong></td>
						</tr>
					</tbody>
				</table>
				...
				<div class="cta" style="margin-top: 20px">
					<a href="view/homepage/banking.jsp" class="cta-btn">Xác nhận thanh toán</a>
